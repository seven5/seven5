...
func (_m *MockPageMapper) ErrorPage(_param0 OauthConnector, _param1 string) string {
...
func (_m *MockPageMapper) LoginLandingPage(_param0 OauthConnector, _param1 string, _param2 string) string {
...
func (_m *MockPageMapper) LogoutLandingPage(_param0 OauthConnector) string {
