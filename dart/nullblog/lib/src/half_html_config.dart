...
/**
 * A unit test configuration for running the tests in the bottom of the browser.  Started by
 * copying from html_config in the unittest package, so I kept the copyright above.
 */
...
void _showResultsInPage(int passed, int failed, int errors,
  ...
  if (isLayoutTest && (passed == results.length) && uncaughtError == null) {
    ...
    query("div#test-results").innerHtml = newBody.toString();
...
void useHalfHtmlConfiguration([bool isLayoutTest = false]) {
