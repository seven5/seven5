...
//handlers (user-level) that are provided as a parameter.  Typically the user-level
//code should never need this as it should be automatically generated by the "tune"
//tool (part of rock_on).
//
...
//WebAppRun takes the named handlers and begins driving HTTP through them.
